...
const FaqItem = ({ faq, index }) => {
  ...
  return (
    <div className="relative mb-16 z-2">
      <div className="relative flex items-center justify-between gap-10 cursor-pointer group px-7"
        onClick={() => {
      ...
      <SlideDown>
        { activeId === faq.id && (<div className="body-3 px-7 py-3.5">{faq.answer}</div>)}
      </SlideDown>
