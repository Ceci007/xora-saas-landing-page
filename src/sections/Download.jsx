...
const Download = () => {
  return (
    <section>
      <Element name="download" className="relative pt-24 pb-32 g7 max-lg:pb-24 max-md:py-16">
              ...
              <ul className="flex flex-wrap items-center gap-6">
                {links.map(({id, url, icon}) => (
                  <li key={id} className="download_tech-link download_tech-link_last-before download_tech-link_last-after">
                    <a href={url} className="relative flex items-center justify-center duration-500 border-2 size-22 download_tech-icon_before rounded-half border-s3 bg-s1 transition-borderColor">
                      <span className="absolute rotate-90 -top-2">
                        <Marker />
                      </span>
                      <img src="/images/lines.svg" alt="lines" className="absolute object-contain size-13/20" />
            ...
            <div className="mb-10 max-md:hidden">
              <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6">
                <div className="relative px-6 pb-6 rounded-3xl bg-s1 pt-14">
                  ...
                  <img src="/images/screen.jpg" alt="demo screen" width={855} height={655} className="rounded-xl" />
                </div>
              </div>
            </div>
          </div>
